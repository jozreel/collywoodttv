...
public class GetRealVidData  extends AsyncTask<String, String, String>{
	private HashMap<String, String> pData = null;
	private videoplay listener;
	public GetRealVidData (HashMap<String, String> data,  videoplay lst)
	{
		pData = data;
		this.listener = lst;
